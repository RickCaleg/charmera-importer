...
internal static class Translations
{
    private static readonly Dictionary<string, string> Portuguese = new()
    {
        ...
        ["Update_ManualNote"] = "Esta instalação é gerenciada pelo sistema (pacote .deb, .rpm ou Arch) — baixe o novo pacote na página da release ou, no Arch, rode o script de instalação de novo.",
    ...
    private static readonly Dictionary<string, string> English = new()
    {
        ...
        ["Update_ManualNote"] = "This installation is managed by your system (a .deb, .rpm or Arch package) — download the new package from the release page or, on Arch, run the install script again.",
